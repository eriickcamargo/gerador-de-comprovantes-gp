...
const STATES = {
  ...
  AWAITING_COLAB_SALARY: 'AWAITING_COLAB_SALARY',
  ...
  // ─── Fluxo de Edição de Colaboradores (por seleção de campo) ───
  AWAITING_COLAB_EDIT_FIELD: 'AWAITING_COLAB_EDIT_FIELD',
  AWAITING_COLAB_EDIT_NOME: 'AWAITING_COLAB_EDIT_NOME',
  AWAITING_COLAB_EDIT_CPF: 'AWAITING_COLAB_EDIT_CPF',
  AWAITING_COLAB_EDIT_CARGO: 'AWAITING_COLAB_EDIT_CARGO',
  AWAITING_COLAB_EDIT_SETOR: 'AWAITING_COLAB_EDIT_SETOR',
  AWAITING_COLAB_EDIT_SALARY: 'AWAITING_COLAB_EDIT_SALARY',
  // ─── Fluxo de Fechamento Mensal de Salários ───
  AWAITING_FECHAMENTO_PERIOD: 'AWAITING_FECHAMENTO_PERIOD',
  AWAITING_FECHAMENTO_METHOD: 'AWAITING_FECHAMENTO_METHOD',
  AWAITING_FECHAMENTO_DATE: 'AWAITING_FECHAMENTO_DATE',
  AWAITING_FECHAMENTO_CONFIRM: 'AWAITING_FECHAMENTO_CONFIRM',
  AWAITING_FECHAMENTO_PIX_VOUCHER: 'AWAITING_FECHAMENTO_PIX_VOUCHER',
  AWAITING_FECHAMENTO_SALARY_CONFLICT_DINHEIRO: 'AWAITING_FECHAMENTO_SALARY_CONFLICT_DINHEIRO',
  AWAITING_FECHAMENTO_SALARY_CONFLICT_PIX: 'AWAITING_FECHAMENTO_SALARY_CONFLICT_PIX',
  // ─── Fluxo de comprovante PIX — colaborador não reconhecido ───
  AWAITING_EMPLOYEE_ACTION: 'AWAITING_EMPLOYEE_ACTION',           // escolha: cadastrar ou selecionar da lista
  AWAITING_VOUCHER_EMP_SELECT: 'AWAITING_VOUCHER_EMP_SELECT',     // seleção do colaborador da lista no fluxo PIX
  // ─── Fluxo de Edição de Recibos ───
  AWAITING_EDIT_FIELD: 'AWAITING_EDIT_FIELD',
  AWAITING_EDIT_AMOUNT: 'AWAITING_EDIT_AMOUNT',
  AWAITING_EDIT_DATE: 'AWAITING_EDIT_DATE',
  AWAITING_EDIT_CARGO: 'AWAITING_EDIT_CARGO',
  AWAITING_EDIT_SETOR: 'AWAITING_EDIT_SETOR',
  AWAITING_EDIT_VALE_TYPE: 'AWAITING_EDIT_VALE_TYPE',
  AWAITING_EDIT_OUTRO_VALE: 'AWAITING_EDIT_OUTRO_VALE',
  AWAITING_EDIT_FERIAS_AQUISITIVO: 'AWAITING_EDIT_FERIAS_AQUISITIVO',
  AWAITING_EDIT_FERIAS_GOZO: 'AWAITING_EDIT_FERIAS_GOZO',
  AWAITING_EDIT_DECIMO_PARCELA: 'AWAITING_EDIT_DECIMO_PARCELA',
  AWAITING_EDIT_DECIMO_ANO: 'AWAITING_EDIT_DECIMO_ANO',
};
